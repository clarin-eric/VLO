        ...
        mockery.checking(new Expectations() {
            {
                ...
                atLeast(1).of(documentService).getSortedDocuments(with(any(QueryFacetsSelection.class)), with(any(String.class)), with(any(String.class)), with(equal(0)), with(equal(1)));
