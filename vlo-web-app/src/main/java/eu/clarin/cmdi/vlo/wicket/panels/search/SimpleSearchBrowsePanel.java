...
public class SimpleSearchBrowsePanel extends GenericPanel<QueryFacetsSelection> {
    ...
    private class FacetSelectorsView extends ListView<FacetField> {
        ...
        public FacetSelectorsView(String id, IModel<QueryFacetsSelection> selectionModel) {
            ...
            setModel(new FacetFieldsModel(facetFieldsService, vloConfig.getSimpleSearchFacetFieldsDiss(), selectionModel, -1));
        }
            ...
            final FacetValuesPanel values = new FacetValuesPanel("values", item.getModel(), selectionModel, Model.of(FacetSelectionType.OR), new Model<FieldValuesFilter>()) {
                ...
                protected void onValuesSelected(FacetSelectionType selectionType, Collection<String> values, AjaxRequestTarget target) {
                    if (selectionType != null && values != null) {
                        ...
                        final QueryFacetsSelection newSelection = selectionModel.getObject().copy();
