...
public class SearchResultItemPanel extends Panel {
    ...
    public SearchResultItemPanel(String id, IModel<SolrDocument> documentModel, IModel<SearchContext> selectionModel, IModel<ExpansionState> expansionStateModel, Ordering<String> availabilityOrdering) {
        ...
        add(new RecordPageLink("recordLink", documentModel, selectionModel)
                .add(new SingleValueSolrFieldLabel("title", documentModel, fieldNameService.getFieldName(KEY.FIELD_NAME), "Unnamed record"))
        );

        add(new FacetSelectLink("searchResultCollectionLink", new SolrFieldStringModel(documentModel, fieldNameService.getFieldName(KEY.FIELD_COLLECTION)), Model.of(fieldNameService.getFieldName(KEY.FIELD_COLLECTION)))
                .add(new SolrFieldLabel("searchResultCollectionName", documentModel, fieldNameService.getFieldName(KEY.FIELD_COLLECTION), "none"))
        );
        ...
        final SolrFieldModel<String> resourcesModel = new SolrFieldModel<>(documentModel, fieldNameService.getFieldName(KEY.FIELD_RESOURCE));
        ...
        final SolrFieldModel<String> partCountModel = new SolrFieldModel<>(documentModel, fieldNameService.getFieldName(KEY.FIELD_HAS_PART_COUNT));
        ...
        add(new WebMarkupContainer("scoreContainer")
                .add(new Label("score", new SolrFieldStringModel(documentModel, fieldNameService.getFieldName(KEY.FIELD_SOLR_SCORE))))
