...
public class FacetMappingFactoryTest {
	...
	public void testGetImdiMapping() {
		...
		assertEquals(1, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:Session/c:MDGroup/c:Location/c:Continent/text()", mapping.getPatterns()
				.get(0));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_COUNTRY, mapping.getName());
		assertEquals(1, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:Session/c:MDGroup/c:Location/c:Country/text()", mapping.getPatterns()
				.get(0));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_LANGUAGE, mapping.getName());
		assertEquals(2, mapping.getPatterns().size());
		assertEquals(
				"/c:CMD/c:Components/c:Session/c:MDGroup/c:Content/c:Content_Languages/c:Content_Language/c:Id/text()",
		...
		assertEquals("/c:CMD/c:Components/c:Session/c:Resources/c:WrittenResource/c:LanguageId/text()", mapping
				.getPatterns().get(1));
		mapping = facets.get(index++);
		...
		assertEquals("/c:CMD/c:Components/c:Session/c:MDGroup/c:Project/c:Contact/c:Organisation/text()", mapping
				.getPatterns().get(0));
		...
		assertEquals(
				"/c:CMD/c:Components/c:Session/c:Resources/c:WrittenResource/c:Access/c:Contact/c:Organisation/text()",
	...
	public void testGetOlacMapping() {
		...
		assertEquals(FacetConstants.FIELD_COUNTRY, mapping.getName());
		assertEquals(2, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:OLAC-DcmiTerms/c:spatial[@dcterms-type=\"ISO3166\"]/text()", mapping
				.getPatterns().get(0));
		assertEquals("/c:CMD/c:Components/c:OLAC-DcmiTerms/c:coverage[@dcterms-type=\"ISO3166\"]/text()", mapping
				.getPatterns().get(1));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_LANGUAGE, mapping.getName());
	...
	public void testGetLrtMapping() {
		...
		assertEquals(FacetConstants.FIELD_NAME, mapping.getName());
		assertEquals(1, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtCommon/c:ResourceName/text()", mapping
				.getPatterns().get(0));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_YEAR, mapping.getName());
		assertEquals(3, mapping.getPatterns().size());
		assertEquals(
				...
				mapping.getPatterns().get(0));
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtLexiconDetails/c:Date/text()", mapping
				.getPatterns().get(1));
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtServiceDetails/c:Date/text()", mapping
				.getPatterns().get(2));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_COUNTRY, mapping.getName());
		assertEquals(2, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtCommon/c:Countries/c:Country/text()", mapping
				.getPatterns().get(0));
		...
		assertEquals(FacetConstants.FIELD_ORGANISATION, mapping.getName());
		assertEquals(1, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtCommon/c:Institute/text()", mapping.getPatterns()
				.get(0));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_GENRE, mapping.getName());
		assertEquals(1, mapping.getPatterns().size());
		...
		assertEquals(FacetConstants.FIELD_DESCRIPTION, mapping.getName());
		assertEquals(2, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtCommon/c:Description/text()", mapping
				.getPatterns().get(0));
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtIPR/c:Description/text()", mapping.getPatterns()
				.get(1));
		mapping = facets.get(index++);
		assertEquals(FacetConstants.FIELD_RESOURCE_TYPE, mapping.getName());
		assertEquals(2, mapping.getPatterns().size());
		assertEquals("/c:CMD/c:Components/c:LrtInventoryResource/c:LrtCommon/c:ResourceType/text()", mapping
				.getPatterns().get(0));
		mapping = facets.get(index++);
		assertEquals("/c:CMD/c:Header/c:MdCollectionDisplayName/text()", mapping.getPatterns().get(0));
		assertEquals(1, mapping.getPatterns().size());
	...
	public void testGetIdMapping() throws Exception {
		...
		assertEquals("/c:CMD/c:Components/c:EastRepublican/c:GeneralInformation/c:Identifier/text()", facet
				.getPatterns().get(1));
	}
