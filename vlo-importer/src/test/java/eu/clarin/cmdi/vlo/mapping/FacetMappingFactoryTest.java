...
public class FacetMappingFactoryTest {
    ...
    public void testGetImdiMapping() {
        FacetMapping facetMapping = FacetMappingFactory.getFacetMapping(FACETCONCEPTS_FILENAME, IMDI_PROFILE_ID, true, config);
    ...
    public void testGetOlacMapping() {
        FacetMapping facetMapping = FacetMappingFactory
                .getFacetMapping(FACETCONCEPTS_FILENAME, OLAC_PROFILE_ID, true, config);
    ...
    public void testGetLrtMapping() {
        FacetMapping facetMapping = FacetMappingFactory
                .getFacetMapping(FACETCONCEPTS_FILENAME, LRT_PROFILE_ID, true, config);
    ...
    public void testGetIdMapping() throws Exception {
        ...
        FacetMapping facetMapping = FacetMappingFactory
                .getFacetMapping(FACETCONCEPTS_FILENAME, ID_PROFILE_ID, true, config);
    ...
    public void testStringBasedBlacklisting() {
        FacetMapping facetMapping = FacetMappingFactory
                .getFacetMapping(FACETCONCEPTS_FILENAME, TEXTCORPUSPROFILE_PROFILE_ID, true, config);
        List<FacetConfiguration> facets = facetMapping.getFacets();
