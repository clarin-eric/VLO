...
public class FacetMappingFactoryTest extends ImporterTestcase {
    ...
    public void testGetImdiMapping() {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_ID), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_SELF_LINK), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_COLLECTION), mapping.getName());
        assertEquals(1, mapping.getFallbackPatterns().size());
        mapping = facets.get(index++);

        assertEquals(fieldNameService.getFieldName(KEY.FIELD_PROJECT_NAME), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_NAME), mapping.getName());
        assertEquals(2, mapping.getPatterns().size());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_TEMPORAL_COVERAGE), mapping.getName());
        assertEquals(2, mapping.getPatterns().size());
        assertEquals("/cmd:CMD/cmd:Components/cmdp:Session/cmdp:Date/text()",
                mapping.getPatterns().get(0).getPattern());
        mapping = facets.get(index++);

        assertEquals(fieldNameService.getFieldName(KEY.FIELD_CONTINENT), mapping.getName());
        assertEquals(1, mapping.getPatterns().size());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_COUNTRY), mapping.getName());
        assertEquals(1, mapping.getPatterns().size());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_LANGUAGE_CODE), mapping.getName());
        assertEquals(2, mapping.getPatterns().size());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_ORGANISATION), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_GENRE), mapping.getName());
        assertEquals(2, mapping.getPatterns().size());
        assertEquals("/cmd:CMD/cmd:Components/cmdp:Session/cmdp:MDGroup/cmdp:Content/cmdp:Genre/text()",
                mapping.getPatterns().get(0).getPattern());
        mapping = facets.get(index++);

        assertEquals(fieldNameService.getFieldName(KEY.FIELD_MODALITY), mapping.getName());
        assertEquals(1, mapping.getPatterns().size());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_SUBJECT), mapping.getName());
        assertEquals(1, mapping.getPatterns().size());
        assertEquals("/cmd:CMD/cmd:Components/cmdp:Session/cmdp:MDGroup/cmdp:Content/cmdp:Subject/text()",
                mapping.getPatterns().get(0).getPattern());
        mapping = facets.get(index++);

        assertEquals(fieldNameService.getFieldName(KEY.FIELD_DESCRIPTION), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_RESOURCE_CLASS), mapping.getName());
        assertEquals(3, mapping.getFallbackPatterns().size());
        mapping = facets.get(index++);

        assertEquals(fieldNameService.getFieldName(KEY.FIELD_FORMAT), mapping.getName());
        assertEquals(1, mapping.getPatterns().size());
        mapping = facets.get(index++);
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_KEYWORDS), mapping.getName());
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_LICENSE), mapping.getName());
    ...
    public void testGetOlacMapping() {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_NATIONAL_PROJECT), mapping.getName());
        assertEquals(1, mapping.getFallbackPatterns().size());
        mapping = facets.get(index++);
    ...
    public void testGetLrtMapping() {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_LICENSE_TYPE), mapping.getName());
    ...
    public void testGetIdMapping() throws Exception {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_ID), facet.getName());
    ...
    public void testStringBasedBlacklisting() {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_TEMPORAL_COVERAGE), facet.getName());
        assertEquals(2, facet.getPatterns().size());
        ...
        facet = facets.get(13);
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_DESCRIPTION), facet.getName());
    ...
    public void testConceptLinkAttributMapping() {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_AVAILABILITY), facet.getName());
    ...
    public void testCLAVASMapping() throws IOException {
        ...
        assertEquals(fieldNameService.getFieldName(KEY.FIELD_LANGUAGE_CODE), facet.getName());
