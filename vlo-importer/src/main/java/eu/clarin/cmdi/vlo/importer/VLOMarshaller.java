...
public class VLOMarshaller {
    ...
    static FacetConceptMapping unmarshal(InputStream inputStream) {
		...
		try {
			result = (FacetConceptMapping) unmarshal(inputStream, FacetConceptMapping.class);
    ...
    /**
     * Get object of specified type from input stream
     *
     * @param inputStream
     * @param clazz
     * @return
     */
    static Object unmarshal(InputStream inputStream, Class<?> clazz)throws JAXBException{
