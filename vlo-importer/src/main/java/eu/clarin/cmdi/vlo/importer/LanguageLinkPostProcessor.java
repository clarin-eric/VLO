...
public class LanguageLinkPostProcessor extends LanguageCodePostProcessor {
    ...
    /**
     * Returns the link to language information If no mapping is found the
    ...
    public List<String> process(String value) {
        ...
        if (langCode != null) {
            if (langCode.startsWith(CODE_PREFIX)) {
                ...
                result = "<a href=\"" + MetadataImporter.config.getLanguageLinkPrefix() + langCode + "\">" + MetadataImporter.languageCodeUtils.getLanguageNameForLanguageCode(langCode.toUpperCase()) + "</a>";
