...
import static eu.clarin.cmdi.vlo.importer.correction.LanguageCodePostCorrection.CODE_PREFIX;
import static eu.clarin.cmdi.vlo.importer.correction.LanguageCodePostCorrection.LANG_NAME_PREFIX;
 ...
 * {@link LanguageCodePostCorrection}) into a languageName value as it should be
 * display in the front end application
 *
 * @author Twan Goosen &lt;twan@clarin.eu&gt;
 */
public class LanguageNamePostCorrection extends AbstractPostCorrection {
    
    private final LanguageCodeUtils languageCodeUtils;

    public LanguageNamePostCorrection(LanguageCodeUtils languageCodeutils) {
